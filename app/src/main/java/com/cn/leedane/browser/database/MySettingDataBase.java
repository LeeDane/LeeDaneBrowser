...
import com.cn.leedane.browser.bean.MySettingBean;
...
public class MySettingDataBase {
    ...
    public static List<MySettingBean> initMySetting(){
        ...
        MySettingBean mySettingBean3 = new MySettingBean(3, "first_load", "15");
        MySettingBean mySettingBean4 = new MySettingBean(4, "other_load", "10");
        ...
        MySettingBean mySettingBean14 = new MySettingBean(14, "share_location", "1");
        ...
        mySettingBeans.add(mySettingBean14);
